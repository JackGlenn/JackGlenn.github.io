...
export default function Home() {
  return (
    <>
      <div className="bio">
        <h1>About</h1>
        <p>Hello, I&apos;m a professional software engineer and a computer science graduate from the University of Michigan. This is a portfolio of some of the projects I have worked on.</p>
      </div>
