    ...
    <>
      ...
      <div className="contentGrid">
        <div className="flexCol">
          <PortfolioItem link={"NeonHammer"} image={"/NeonHammer.png"} name={"NeonHammer"} description={"Fast paced action game built in Unity"}/>
        ...
        <div className="flexCol">
          <PortfolioItem link={"a"} name={"fourth"} description={"description"}/>
