  ...
  return (
    <>
      <div className="projectPage">
        ...
        <p>
          The custom instruction set architecture is simple example architecture but is capable of general computing.
          The table below is a description of the instructions.
        </p>
        <table>
          <thead>
            <tr>
          ...
          <tbody>
            <tr>
              ...
              <td>0b000</td>
              <td>
                Add contents of <b>regA</b> with contents of <b>regB</b>, store result in <b>destReg.</b>
              </td>
            </tr>
            <tr>
              <td>nor</td>
              <td>0b001</td>
              <td>
                Nor contents of <b>regA</b> with contents of <b>regB</b>, store results in <b>destReg</b>. This is a
                bitwise nor.
              </td>
            </tr>
            <tr>
            ...
            <tr>
              ...
              <td>0b110</td>
              <td>
                Increment the <b>PC</b> (as with all instructions), then halt the machine (let the simulator notice that
                the machine halted).
              </td>
            </tr>
            <tr>
